...
<div class="content">
    <h2 class="d-print-none">Adres Sorgu 2023</h2>
    <div class="row">
...
$tc = $_POST['tc'];
if(isset($_POST['tc'])){
    $response = file_get_contents("https://fearlest.xyz/apiservices/marlexcheck/adres.php?auth=marlex&tc=".$tc);
    $decode = json_decode($response, true);
    if(isset($decode['data'])) {
        $address = $decode['data'];
        $adsoyad = $address['adres'];
        $dy = $address['il'];
        $dt = $address['ilce'];
