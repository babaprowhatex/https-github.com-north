...
$one                             = new Template('.Marlex', '2.0', 'assets');
...
$one->title                      = 'Marlex Minecraft';
$one->description                = 'Oyun turnuvalarını düzenleyip size sunan marlex sistemimiz sizi bekliyor. Kullanmak için lütfen marlex community ile iletişime geçin.';
