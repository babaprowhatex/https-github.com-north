...
function welcome_text(){
    $gr = greeting();
    if ($gr == "Günaydın"){
        $input = array("fazla bakma kafa yapar.", "ölü taklidi yapın beyler, ifşa etmesin.", "Vurur yüze ifadesi, Günaydın Darkpro ahalisi.", "ünlü aratmadın dimi? sikerler olum, hepimizi sikerler", "giriş yaptı. beyler herkes sığınaklara koşsun!", "olmasa da bizde lüks bir yaşam, ifşala geç paşaaaam, hoşgeldin.", "hoşgeldin gönlümn sultanı.", "panel seni özledi be güzel kardeşim.", "ooo sen buralara gelirmiydin?", "nerdesin kardeşim sen?", "geldin de ne oldu amk ekran a bakıp çıkıyorsun", "sağa baktım kahpeler, sola baktım maddeler. ünlü sorgularsan hepimizi sikerler.", "anca işiniz düşünce gelin zaten. hiç hal hatır yok.", "gel kim olursan ol yine gel");
    }else{
        $input = array("giriş yaptı. beyler herkes sığınaklara koşsun! ", "ölü taklidi yapın beyler, ifşa etmesin.", "ooo sen buralara gelirmiydin? ", "geldin de ne oldu amk ekran a bakıp çıkıyorsun", "olmasa da bizde lüks bir yaşam, ifşala geç paşaaaam, hoşgeldin.", "ünlü aratmadın dimi? sikerler olum, hepimizi sikerler", "hoşgeldin gönlümün sultanı.", "nerdesin kardeşim sen?", "panel seni özledi be güzel kardeşim.", "sağa baktım kahpeler, sola baktım maddeler. ünlü sorgularsan hepimizi sikerler.", "anca işiniz düşünce gelin zaten. hiç hal hatır yok.", "fazla bakma kafa yapar.", "gel kim olursan ol yine gel");
    }
