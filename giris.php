...
<i class="fa fa-fw fa-plus me-1"></i>
          ...
          <div class="block-content">
            <div class="p-sm-3 px-lg-4 px-xxl-5 py-lg-5">
              ...
              <form class="js-validation-signin" action="" method="POST">
                <div class="py-3">
				  <div class="mb-4">
                    <img id="logo-container" class="h2 mb-1" src="assets/media/photos/agah_3000.png" alt="Login Logo" style="width: 280px;">
                 
                  </div>
                  <div class="alert alert-primary" role="">
                  Telegram adresimizden bilgi alabilirsiniz.              </div>
                  <div class="mb-4">
    ...
    <div class="fs-sm text-muted text-center">
      <strong><?php echo "Marlex Community -" . ' ' . $one->version; ?></strong> &copy; <span data-toggle="year-copy"></span>
	  <a class="link-fx" href="https://t.me/marlexcheck">Telegram Katıl</a>
  </div>
</div>
